...
import ua.dp.comtesys.MainApp;
import ua.dp.comtesys.model.Person;
import ua.dp.comtesys.utils.DateUtil;
...
public class PersonOverviewController {
    ...
    private void handleDeletePerson() {
        ...
        if (selectedIndex >= 0) {
            ...
            alert.setHeaderText("Не выбран персонаж");
            alert.setContentText("Пожалуйста, выберите персонаж в таблице.");
